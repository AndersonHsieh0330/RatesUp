...
interface CurrencyDataAPI {
    ...
    suspend fun getCurrencyData(@Query("base_currency")baseCurrency:String, @Query("date_from")fromCurrency:String, @Query("date_to")toCurrency:String): APIResponseObject
}